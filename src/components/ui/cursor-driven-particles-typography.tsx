...
export function CursorDrivenParticleTypography({
  className, text, fontSize = 120, fontFamily = "Inter, sans-serif",
  particleSize = 1.5, particleDensity = 6, dispersionStrength = 15,
  returnSpeed = 0.08, color,
  ...
  useEffect(() => {
    ...
    return () => {
      clearTimeout(timeoutId); resizeObserver.disconnect();
